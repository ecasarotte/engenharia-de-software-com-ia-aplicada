export class View {
    ...
    initializeParameters(params) {
        this.elements.topK.max = 50; //params.maxTopK;
        this.elements.topK.min = 1;
        this.elements.topK.value = 5;//params.defaultTopK;
        ...
        this.elements.temperature.max = 2//params.maxTemperature;
        this.elements.temperature.min = 0;
        this.elements.temperature.value = 1;//params.defaultTemperature;
    }
